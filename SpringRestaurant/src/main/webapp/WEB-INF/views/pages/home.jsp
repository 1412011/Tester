 <div class="gradient fm-main-header ">
                    ...
                    <div class="ng-isolate-scope">
                        <div class="bar">
                            <div class="view-menu">
                                ...
                                <div class="arrow"><span>Dictris 1 HCM</span></div>
        ...
        <!-- Menu -->
        <!-- <div id="fm-collection-nav" class="fm-collection-nav">
            <ul>

                <li ng-if="(newFilterList.length>0 || showOnlyExpressItems) ? hasCollectionAnyCategoryItems(collection, newFilterList) : true" ng-repeat="collection in menu.collections track by $index" ng-click="setCollection(collection); fireGAEvent('Menu', 'click', collection.name.split(' ').join('_'), $index)" id="fm-nav-id-1" class="ng-scope">
                    <a ng-class="{'active':(selectedCollection.id == collection.id &amp;&amp; !scrollingAnimation)}" href="#main" class="ng-binding">Mains and Sides</a>
                </li>

                <li ng-if="(newFilterList.length>0 || showOnlyExpressItems) ? hasCollectionAnyCategoryItems(collection, newFilterList) : true" ng-repeat="collection in menu.collections track by $index" ng-click="setCollection(collection); fireGAEvent('Menu', 'click', collection.name.split(' ').join('_'), $index)" id="fm-nav-id-10" class="ng-scope">
                    <a ng-class="{'active':(selectedCollection.id == collection.id &amp;&amp; !scrollingAnimation)}" href="#dinner" class="ng-binding">Dinner Meals</a>
                </li>

                <li ng-if="(newFilterList.length>0 || showOnlyExpressItems) ? hasCollectionAnyCategoryItems(collection, newFilterList) : true" ng-repeat="collection in menu.collections track by $index" ng-click="setCollection(collection); fireGAEvent('Menu', 'click', collection.name.split(' ').join('_'), $index)" id="fm-nav-id-6" class="ng-scope">
                    <a ng-class="{'active':(selectedCollection.id == collection.id &amp;&amp; !scrollingAnimation)}" href="#" class="ng-binding">Pizzas</a>
                </li>
               
                <li ng-if="(newFilterList.length>0 || showOnlyExpressItems) ? hasCollectionAnyCategoryItems(collection, newFilterList) : true" ng-repeat="collection in menu.collections track by $index" ng-click="setCollection(collection); fireGAEvent('Menu', 'click', collection.name.split(' ').join('_'), $index)" id="fm-nav-id-5" class="ng-scope">
                    <a ng-class="{'active':(selectedCollection.id == collection.id &amp;&amp; !scrollingAnimation)}" href="#" class="ng-binding">Soups and Salads</a>
                </li>
               
                <li ng-if="(newFilterList.length>0 || showOnlyExpressItems) ? hasCollectionAnyCategoryItems(collection, newFilterList) : true" ng-repeat="collection in menu.collections track by $index" ng-click="setCollection(collection); fireGAEvent('Menu', 'click', collection.name.split(' ').join('_'), $index)" id="fm-nav-id-4" class="ng-scope">
                    <a ng-class="{'active':(selectedCollection.id == collection.id &amp;&amp; !scrollingAnimation)}" href="#" class="ng-binding">Quick Bites</a>
                </li>
               
                <li ng-if="(newFilterList.length>0 || showOnlyExpressItems) ? hasCollectionAnyCategoryItems(collection, newFilterList) : true" ng-repeat="collection in menu.collections track by $index" ng-click="setCollection(collection); fireGAEvent('Menu', 'click', collection.name.split(' ').join('_'), $index)" id="fm-nav-id-3" class="ng-scope">
                    <a ng-class="{'active':(selectedCollection.id == collection.id &amp;&amp; !scrollingAnimation)}" href="#" class="ng-binding">Desserts</a>
                </li>
                                ...
                                <div class="content out-cart">
                                    ...
                                    <div class="fm-product-detail">
                                        <div class="fm-badge-container">
                                            <!-- ngIf: product.tagsList.length > 0 && product.tagsList[0] && product.tagsList[0].length > 0 -->
                                        ...
                                        <div class="fm-actions" count="0">
                                            ...
                                            <div class="button add no-animate ng-scope" ng-if="!product.soldOut &amp;&amp; checkTimings(product.timings, true) &amp;&amp; !kitchenClosed &amp;&amp; isTodaysMenu">
                                                <div ng-if="getProductQuantity(product)==0" ng-click="addToCart(product,1);$event.stopPropagation();fireGAEvent('Menu', 'click', 'add_to_cart')" class="ng-scope">Add to cart</div>
                                                <!-- <div ng-if="getProductQuantity(product)>0" ng-click="removeFromCart(product,1);$event.stopPropagation();fireGAEvent('Menu', 'click', 'remove_from_cart')" class="ng-scope">-</div>
                                                <div class="count ng-binding ng-scope" ng-if="getProductQuantity(product)>0" ng-click="$event.stopPropagation();">1</div>
                                                <div ng-if="getProductQuantity(product)>0" ng-click="addToCart(product,1);$event.stopPropagation();fireGAEvent('Menu', 'click', 'add_to_cart')" class="ng-scope">+</div> -->
                                            </div>
                                        </div>
        ...
        <div class="cart" ng-class="{'cart--limit-height': upsaleProducts.length}">
            ...
            <div class="items ng-hide" ng-show="cart.items.length">
                ...
                <div class="item ng-scope" ng-repeat="item in cart.items" style="">
                    <div class="close" ng-click="removeFromCart(item.productDTO,item.quantity,true,item.quantity); fireGAEvent('Cart', 'click', 'remove_from_cart')">×</div>
