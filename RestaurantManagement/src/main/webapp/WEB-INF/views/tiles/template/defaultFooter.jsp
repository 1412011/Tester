	...
	<div class="row">
		<div class="company">
			...
			<ul>
				...
				<li><a href="#" class="GTM_careers_button">Careers</a></li>
				<li><a href="#" class="GTM_blog_button">Blog</a></li>
			</ul>
			<div class="terms-and-privacy">
				<a href="#" class="GTM_terms_and_conditions_button">Terms</a> <a
					href="#" class="GTM_privacy_policy_button">Privacy</a>
			</div>
		</div>
		<div class="help-and-contact">
			...
			<ul>
				<li class="toggle-modal-support"><a
					class="nav-item nav-link hover support-link fm-link-icons" href="#">
						Help Center </a></li>
				<li><a class="fm-email-support fm-link-icons" target="_top"
					href="#"> Email Us </a></li>
				<li><a class="fm-faq fm-link-icons">
						080-4042-4242 </a></li>
			</ul>
		</div>
		...
		<div class="subscribe">
			...
			<form class="input fm-enter-email-container"
				name="SubscribeForm">
				<input type="text" id="fmSubscribeEmail"
					placeholder="Enter your email" name="EMAIL"
					class=""> <input
					type="hidden" name="b_e748898a87563c233275c9cc4_63ede23e7c"
					value="">
				<button type="submit" class="GTM_subscribe_button">Subscribe</button>
			</form>
			<div class="social">
				<a class="GTM_android_app_button google" href="#"></a> <a
					class="GTM_iPhone_app_button apple" href="#"></a>
				<div class="divider"></div>
				<a href="#" class="facebook"> <!--?xml version="1.0" encoding="UTF-8" standalone="no"?-->
					<svg width="19px" height="19px" viewBox="0 0 19 19" version="1.1"
						xmlns="http://www.w3.org/2000/svg"
						xmlns:xlink="http://www.w3.org/1999/xlink">
                            <defs></defs>
                            <g id="Homepage" stroke="none"
							stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="Homepage---States"
							transform="translate(-62.000000, -348.000000)" fill="#5C6C79">
                                    <path
							d="M80.9994825,365.950942 C80.9994825,366.530072 80.5300719,367 79.9509425,367 L75.1093375,367 L75.1093375,359.642106 L77.5790477,359.642106 L77.9490902,356.774924 L75.1093375,356.774924 L75.1093375,354.94386 C75.1093375,354.113723 75.3401613,353.54805 76.5305077,353.54805 L78.0489758,353.547532 L78.0489758,350.982594 C77.7860645,350.947919 76.885024,350.86977 75.836484,350.86977 C73.6472815,350.86977 72.1484801,352.206063 72.1484801,354.660247 L72.1484801,356.774924 L69.6725594,356.774924 L69.6725594,359.642106 L72.1484801,359.642106 L72.1484801,367 L63.04854,367 C62.4694105,367 62,366.530072 62,365.950942 L62,349.049058 C62,348.469411 62.4694105,348 63.04854,348 L79.9509425,348 C80.5300719,348 80.9994825,348.469411 80.9994825,349.049058 L80.9994825,365.950942"
							id="Facebook"></path>
                                </g>
                            </g>
                        </svg>
				</a> <a href="#" class="twitter"> <!--?xml version="1.0" encoding="UTF-8" standalone="no"?-->
					<svg width="20px" height="17px" viewBox="0 0 20 17" version="1.1"
						...
						xmlns:xlink="http://www.w3.org/1999/xlink">
							...
							stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="Homepage---States"
							transform="translate(-102.000000, -349.000000)" fill="#5C6C79">
                                    <path
				...
				</a> <a href="#" class="instagram"> <!--?xml version="1.0" encoding="UTF-8" standalone="no"?-->
					<svg width="19px" height="19px" viewBox="0 0 19 19" version="1.1"
						xmlns="http://www.w3.org/2000/svg"
						xmlns:xlink="http://www.w3.org/1999/xlink">
                            <defs></defs>
