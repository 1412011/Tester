...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity
				.authorizeRequests().antMatchers("/admin/**").access("hasRole('ADMIN')").antMatchers("/account/**")
				.access("hasRole('CLIENT')").antMatchers("/checkout/**").access("hasRole('CLIENT')")
				.antMatchers("/order-history/**").access("hasRole('CLIENT')")
